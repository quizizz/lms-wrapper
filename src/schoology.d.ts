...
declare class Schoology {
  ...
  getSchoolBuildings(id: string): Promise<Building[]>;
  getBuildingCourses(params: { buildingId: string }): Promise<Course[]>;
  getAllSectionsForCourse(courseId: string): Promise<Section[]>;
  listUsers(params: { sectionId: string, query: EnrollmentFilterOptions }): Promise<Enrollment[]>;
  getUser(uid: string): Promise<Profile>;
}
